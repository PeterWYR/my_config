...
-- =============================================================================
--  CORE KEYBINDINGS: The "IJKL" Layout
-- =============================================================================

-- Shorten function name for cleaner code
local map = vim.keymap.set
local opts = { noremap = true, silent = true, desc = '' }

-- --- 1. Basic Movement (IJKL) ---
...
map('n', '-', 'Nzz', { desc = 'Previous search result' })
  ...
  -- Theme: Dracula
  {
    ...
    config = function()
      require('dracula').setup {
        ...
        italic_comment = true, -- Fancy comments
      }
    ...
    config = function()
      ...
      require('neo-tree').setup {
        window = {
          position = 'left',
          width = 30,
          -- === MAPPINGS FOR IJKL IN FILE TREE ===
          mappings = {
            ['i'] = 'move_cursor_up', -- Up
            ['k'] = 'move_cursor_down', -- Down
            ['j'] = 'close_node', -- Left (Close folder)
            ['l'] = 'open', -- Right (Open folder/file)

            -- Unmap standard keys to prevent conflicts if needed
            ['<Up>'] = 'move_cursor_up',
